...
def get_user_twits(request, take, start_from_id, user_id):
    twits = Tweet.objects.get_user_twits(request.user, take, start_from_id, user_id)
...
def get_media_twits(request, take, start_from_id, user_id):
    twits = Tweet.objects.get_user_twits(request.user, take, start_from_id, user_id, image__isnull=False)
